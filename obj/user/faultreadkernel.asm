	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d7:	0f be 80 51 0e 80 00 	movsbl 0x800e51(%eax),%eax
  8001de:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80036b:	50                   	push   %eax
  80036c:	68 69 0e 80 00       	push   $0x800e69
  800371:	53                   	push   %ebx
  800372:	56                   	push   %esi
  ...
  800386:	52                   	push   %edx
  800387:	68 72 0e 80 00       	push   $0x800e72
  80038c:	53                   	push   %ebx
  80038d:	56                   	push   %esi
  ...
  8003b1:	b8 62 0e 80 00       	mov    $0x800e62,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b68:	e8 6b f5 ff ff       	call   8000d8 <vcprintf>
	cprintf("\n");
  800b6d:	c7 04 24 b0 10 80 00 	movl   $0x8010b0,(%esp)
